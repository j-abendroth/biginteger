//-----------------------------------------------------------------------------
// List.c
// Implementation file for List ADT, modified for PA3
// John Abendroth
// CruzID: jabendro
// Assignment: PA3
//-----------------------------------------------------------------------------
...
/*
// equals()
// Returns true iff lists A & B are in the same state, otherwise returns 0
...
// copyList()
// Returns new List representing the same integer sequence as L. The cursor in the new list is undefined, regardless of the state of the cursor in L. The state of L is unchanged
